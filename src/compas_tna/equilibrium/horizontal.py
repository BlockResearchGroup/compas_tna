...
# def _horizontal_nodal(form, force, alpha=100, kmax=100, display=True):
#     pass


# def _parallelise_form_nodal(form, targets, fixed=None, kmax=1, callback=None, callback_args=None):
...
#     uv_e = {(u, v): index for index, (u, v) in enumerate(mesh.edges())}
